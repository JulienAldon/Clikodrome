...
const resources = {
  en: {
    translation: {
        ...
        'Fetch session presence status from epitech intranet': 'Fetch session presence status from epitech intranet',
        'Fetch from intra': 'Fetch from intra',
        ...
        'Sessions': 'Sessions',
        'Logout': 'Logout',
        'Select promotion name': 'Select promotion name',
        'Manager': 'Manager',
        'Year of the promotion': 'Year of the promotion',
        'Year': 'Year',
        ...
        'Thursday': 'Thursday',
        'Friday': 'Friday',
        'Weekplan deleted': 'Weekplan deleted',
  ...
  fr: {
    translation: {
        ...
        'Fetch session presence status from epitech intranet': 'Met à jour la session avec les informations actuelles de l\'intranet',
        'Fetch from intra': 'Récuperer depuis l\'intranet',
        ...
        'Select promotion name': 'Selectioner une promotion',
        'Manager': 'Gestion',
        'Year of the promotion': 'Année de la promotion',
        'Year': 'Année',
        'Add a new promotion.': 'Ajouter une nouvelle promotion',
        'New promotion added': 'Nouvelle promotion ajoutée',
        'Promotion deleted': 'Promotion supprimée',
        'Remove promotion.': 'Supprimer la promotion.',
        'Monday': 'Lundi',
        'Tuesday': 'Mardi',
        'Wednesday': 'Mercredi',
        'Thursday': 'Jeudi',
        'Friday': 'Vendredi',
        'Weekplan deleted': 'Weekplan supprimé',

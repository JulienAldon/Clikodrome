...
export default function About() {
	...
	return (
		<section class={`${styles.about} ${token ? "" : styles.disconnected}`}>
			<h1>Welcome to Clicodrome</h1>
			<h2>Cohesive Listing Initiative Concerning Official Date Recollection Over Mediocre Edusign</h2>
			{
				token ?
				<div class={`${styles.divLink}`}>
					<Volet title="Why clicodrome ?">
					<p>
					...
					<Volet title="How to use the clicodrome ?">
					<ul>
						...
						{/* <img src={'../assets/demo_sessions.png'}></img> */}
						...
						{/* <img src={'../assets/demo_session.png'}></img> */}
						...
						{/* <img src={'../assets/demo_remote.png'}></img> */}
					</ul>
					</Volet>
					<Volet title="What clicodrome do ?">
						<ul>
					...
					<Volet title="What clicodrome doesn't do ?">
					<ul>
